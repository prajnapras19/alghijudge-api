                  ...
                  if (i === 0) {
                    java.runFile(
                      ...
                      (err, result) => {
                        if (err) {
                          submitRecord[newClassName]["failedmsg"] =
                            "Error compiling/running the program";
                          reject(new Error(err));
                        } else {
                          ...
                          if (inputData.length >= 100000) {
                            inputData = `https://raw.githubusercontent.com/prajnapras19/alghijudge-api/master/static/${problemName}/in${
                              i + 1
                            }`;
                          }
                          if (outputData.length >= 100000) {
                            outputData = `https://raw.githubusercontent.com/prajnapras19/alghijudge-api/master/static/${problemName}/out${
                              i + 1
                            }`;
                          }
